(() => {
    ...
    define("extraTime", ["require", "exports", "utils"], function (require, exports, utils_1) {
        ...
        const runExtraTime = async () => {
            chrome.storage.sync.get({
                ...
                const listOfPageValue = document.getElementById("ctl00_ctl00_ctl00_C_C_C_grdRequest_ctl00_ctl03_ctl01_PageSizeComboBox_Input");
                if (listOfPageValue) {
                    if (listOfPageValue.value !== "50") {
                        const listOfPageAction = document.querySelector(".rcbActionButton");
                        if (listOfPageAction) {
                            ...
                            if (listOfPageActionList) {
                                const main = listOfPageActionList.querySelector("#ctl00_ctl00_ctl00_C_C_C_grdRequest_ctl00_ctl03_ctl01_PageSizeComboBox_DropDown");
                                if (main) {
                                    const children = main === null || main === void 0 ? void 0 : main.querySelector(".rcbScroll");
                                    if (children) {
                                        const ul = children === null || children === void 0 ? void 0 : children.querySelector(".rcbList");
                                        const li = ul === null || ul === void 0 ? void 0 : ul.querySelectorAll("li");
                                        if (li) {
                                            li[2].click();
                                            await utils_1.sleep(5000);
                                            const getTable = document.getElementById("ctl00_ctl00_ctl00_C_C_C_grdRequest");
                                            if (getTable) {
                                                ...
                                                if (table) {
                                                    ...
                                                    if (tbody) {
                                                        ...
                                                        if (trs) {
                                                            trs.forEach((tr) => {
                                                                var _a;
                                                                const startDate = (_a = tr.querySelectorAll("td")[1]) === null || _a === void 0 ? void 0 : _a.textContent;
                ...
                if (_tdsDate) {
                    const tdsDate = JSON.parse(_tdsDate);
    ...
    define("myActivity", ["require", "exports", "utils"], function (require, exports, utils_2) {
        ...
        const addExtraTimes = async () => {
            ...
            trs.forEach((tr, index) => {
                ...
                if (exitTime === null || exitTime === void 0 ? void 0 : exitTime.includes("اضافه کاری")) {
                    return;
                }
    ...
    define("myCardTable", ["require", "exports", "utils"], function (require, exports, utils_3) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        exports.runMyCardTable = void 0;
        const runMyCardTable = async () => {
            var _a;
            await utils_3.sleep(1000);
            const timeout = setTimeout(runMyCardTable, 3000);
            const iframe = (_a = document.getElementsByClassName("Boxes_nb")) === null || _a === void 0 ? void 0 : _a[0];
            if (!iframe) {
                return;
            }
            const rwTitleWrapper = document.querySelector(".pagetitle");
            ...
            addExtra.onclick = async () => {
                ...
                await utils_3.sleep(300);
                const iDocument = iframe.querySelector("#ctl00_ctl00_ctl00_C_C_C_grdRequest");
                // console.log({ iDocument });
                if (!iDocument) {
                    console.log("WindowShowDialog not found");
                    return;
                }
                const trs = iDocument.querySelectorAll("#ctl00_ctl00_ctl00_C_C_C_grdRequest_ctl00 tbody tr");
                while (trs.length > 0) {
                    await utils_3.sleep(1000);
                    const tr = trs[0];
                    if (!tr) {
                    ...
                    await utils_3.sleep(1000);
                    const _iframe = (_a = document.getElementsByName("myPopupWindow")) === null || _a === void 0 ? void 0 : _a[0];
                    if (!_iframe) {
                        return;
                    }
                    _iframe.focus();
                    await utils_3.sleep(3000);
                    const _iDocument = (_b = _iframe.contentWindow) === null || _b === void 0 ? void 0 : _b.document;
                    (_c = _iDocument === null || _iDocument === void 0 ? void 0 : _iDocument.getElementById("ctl00_C_btnAccept")) === null || _c === void 0 ? void 0 : _c.click();
                    await utils_3.sleep(3000);
                }
            };
            rwTitleWrapper.innerText = "";
        ...
        exports.runMyCardTable = runMyCardTable;
    });
    define("requestLeave", ["require", "exports", "utils"], function (require, exports, utils_4) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        const runRequestLeave = async () => {
            chrome.storage.sync.get({
                ...
                if (!iDocument.getElementById("ctl00_C_tpEndTime_dateInput")) {
                    await utils_4.sleep(2000);
                }
                if (iDocument.getElementById("ctl00_C_tpEndTime_dateInput")) {
                    await utils_4.setValue(iDocument, "ctl00_C_txtDesc", ".");
                    await utils_4.setValue(iDocument, "C_dpDate_txtDate", item.date);
                    await utils_4.setValue(iDocument, "ctl00_C_tpStartTime_dateInput", "8:30 AM");
                    await utils_4.setValue(iDocument, "ctl00_C_tpEndTime_dateInput", item.startTime);
                    await utils_4.sleep(300);
                    (_d = iDocument.getElementById("ctl00_C_btnSave")) === null || _d === void 0 ? void 0 : _d.click();
                    const interval = setInterval(() => {
                        var _a;
                        const visibility = (_a = document.getElementById("RadWindowWrapper_ctl00_ctl00_ctl00_C_C_C_myPopupWindow")) === null || _a === void 0 ? void 0 : _a.style.visibility;
    ...
    define("index", ["require", "exports", "extraTime", "myActivity", "myCardTable", "requestLeave"], function (require, exports, extraTime_1, myActivity_1, myCardTable_1, requestLeave_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
